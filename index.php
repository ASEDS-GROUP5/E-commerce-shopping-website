...
<body style="background-color: snow;">
    <header class="navbar" style="background-color:rgb(172, 13, 13);text-align:center; ">
        ...
        <nav class="col-sm-5" style="color:rgb(7, 7, 6);padding: 20px;font-size:large; ">
            <div class="navbar-header " style="color: mintcream;">
                <ul class="n">
                    <li id="nav"><a id="nav" href="home.html">Home </a></li>|
                    ...
                    <li id="nav"><a id="nav" href="">Contact us </a></li>|
                    <li id="nav"><a id="nav" href=" "> Help</a></li>
                </ul>
            </div>
        </nav>
        <?php
    ...
    <div class="container">
        ...
        <form class="navbar-form navbar-left" action="/action_page.php">
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Search" style="width: 400px;margin-left: 250px;border-radius: 5px 5px 5px 5px;border: black 2px solid; ">
    ...
    <div class="container-fluid text-center">
        ...
        <dl style="color: oldlace; ">
            ...
            global $db;
                $products=$db->prepare("SELECT photo,description,product_name,price from products where category_name='Women s fashion' LIMIT 3");
                $products->execute();
    ...
    <div class="container-fluid text-center ">
        ...
        <dl style="color: oldlace; ">
            ...
            <?php
                $products=$db->prepare("SELECT photo,description,product_name,price from products where category_name='Men s fashion' LIMIT 3");
                $products->execute();
                foreach($products as $row){
                    $photo=$row['photo'];
                    $pname=$row['product_name'];
